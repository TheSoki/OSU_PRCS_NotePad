...
export const NoteActions: FC<{
    onDeleteClick: () => void
    editHref: string
}> = ({ onDeleteClick, editHref }) => (
    <div className="inline-flex items-center rounded-md shadow-sm">
        <Link href={editHref}>
            <div className="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
                <span>
                    <svg
